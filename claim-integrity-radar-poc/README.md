...
Claim Integrity Radar is a simple browser-based prototype for prompt 2. It shows how clinical decision making and pattern recognition can support payment operations through:
...
- Explainable anomaly scoring with an evidence chain for each flagged claim
...
6. Click `Export Audit Packet` to show how an investigator handoff could work.
